import { songs, SongSound } from './songs';

/**
 * Given a starting sound, returns the rest of the song as SongSound entries.
 */
export function getSongContinuation(inputSound: string): SongSound[] {
...
export function getRemainingSounds(inputSound: string): string[] {
  return getSongContinuation(inputSound).map(e => e.sound);
}
